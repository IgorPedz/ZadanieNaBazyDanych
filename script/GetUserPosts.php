...
// Sprawdzanie, czy parametr 'id_user' jest w URL
$userId = isset($_GET['user_id']) ? (int)$_GET['user_id'] : 0;

if ($userId === 0) {
    echo json_encode(['error' => 'Brak ID użytkownika w zapytaniu']);
    exit;
}

// Zapytanie do bazy danych o posty dla konkretnego użytkownika
$sql = "
    SELECT
        p.ID_postu,
        p.Tytul,
...
if ($result->num_rows > 0) {
    ...
    echo json_encode(['error' => 'Brak postów dla tego użytkownika']);
    exit;
}
